...
export function BottomNav() {
  ...
  return (
    <nav aria-label="Main navigation" className="fixed bottom-0 left-0 right-0 pb-safe-bottom bg-white/80 dark:bg-black/80 backdrop-blur-lg border-t border-gray-200 dark:border-gray-800 shadow-[inset_0_1px_0_0_rgba(0,0,0,0.05)] dark:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)]">
      <div className="flex justify-around items-center h-16 max-w-md mx-auto px-4">
        {tabs.map((tab) => {
          // Handle nested routes: /expenses/new should highlight Expenses tab
